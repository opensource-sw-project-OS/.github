...
---
## 프로젝트 진행 현황 - Projects - project_os project
https://github.com/orgs/opensource-sw-project-OS/projects/2
![image](https://github.com/user-attachments/assets/909a3681-c1dc-40a4-a6c4-653d1109fdbd)


---

## 📎 차별화 요소 : 다양한 오픈소스 기술 적극 활용
...
- 회의 내용
  - API 명세서 작성 
  - 배포 방식 및 환경 구성 방법 논의
  - 예산 탭에 남은 예산 계산 및 예산 초과 시 경고 기능 추가 결정
  - 사용자 지출 및 감정 데이터를 기반으로 개인화 피드백 기능 강화 방안 논의
  - 프로젝트 개인 회고 및 전체 회고
...
| 기간        | 내용                                                             |
|-------------|------------------------------------------------------------------|
| 2025.04  | 아이디어 기획, 화면 설계 완료                                   |
| 2025.05  | 기본 기능 구현 및 오픈소스 기능 통합, 백엔드 연동 시작, 오픈소스 기능 통합 마무리, 백엔드 기능 연동 완료        |
| 2025.06  | 예산, 감정, 지출 시각화 및 통합 기능 완성, 테스트 및 배포 진행                         |
